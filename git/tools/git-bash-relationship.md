...
![git-bash-comtempt-cmd.jpg](https://upload-images.jianshu.io/upload_images/16648241-1a88039e11404bf1.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-gui-gibberish.png](https://upload-images.jianshu.io/upload_images/16648241-72b4151899121e9c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

不是说好闪亮登场的吗,怎么右侧文件区是乱码?别急,简单设置下编码方式就能正常显示中文了.

![git-bash-gui-encoding-utf8.png](https://upload-images.jianshu.io/upload_images/16648241-a2c9053469c1cc38.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

> 在菜单栏选择编辑(`Edit`),然后选择选项(`Options...`),在设置页面左侧中间部分选择文件编码格式(`Default File Content Encoding`) 修改(`Change`)成 `utf-8`.

![git-bash-gui-encoding-success.png](https://upload-images.jianshu.io/upload_images/16648241-bd0525343eb562da.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

解决好中文乱码显示问题,现在演示下 `git` 的基本工作流.

![git-bash-gui-operation.gif](https://upload-images.jianshu.io/upload_images/16648241-11f4807cc63d4705.gif?imageMogr2/auto-orient/strip)
...
![git-bash-bash-operation.gif](https://upload-images.jianshu.io/upload_images/16648241-b24c90807f4d2b32.gif?imageMogr2/auto-orient/strip)
...
![git-bash-windows.png](https://upload-images.jianshu.io/upload_images/16648241-6560adbb33cd5143.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-github-git.png](https://upload-images.jianshu.io/upload_images/16648241-b8fcfc49ecd9471b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

### `Git` 和 `Git for Windows`

最初 `git` 只支持 `linux` 操作系统,后来 `windows` 系统也慢慢支持了,只不过这种支持并不是 `git` 官方所为,而是**微软**团队进行移植整合的产品.

![git-bash-github-gitforwindows.png](https://upload-images.jianshu.io/upload_images/16648241-0aee8d0b03812328.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-cmd-operation.gif](https://upload-images.jianshu.io/upload_images/16648241-d22b70ac3fdbb60d.gif?imageMogr2/auto-orient/strip)

> `cmd` 想要切换到指定目录,首先需要切换**盘符**,然后再使用 `cd` 命令切换到该盘符下的指定目录.

![git-bash-gitbash-operation.gif](https://upload-images.jianshu.io/upload_images/16648241-28fbef25a528c420.gif?imageMogr2/auto-orient/strip)
...
![git-bash-setup-terminal.png](https://upload-images.jianshu.io/upload_images/16648241-767932779590791f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-mintty-msys2.png](https://upload-images.jianshu.io/upload_images/16648241-f11053b6d4384f13.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-mintty-about.png](https://upload-images.jianshu.io/upload_images/16648241-483a725d7dba5ec4.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-mintty.github.io.png](https://upload-images.jianshu.io/upload_images/16648241-21c565d20bca721f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-options-terminal.png](https://upload-images.jianshu.io/upload_images/16648241-5055fa8c9954844b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-wsltty.png](https://upload-images.jianshu.io/upload_images/16648241-8b1b66d82918f516.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-mintty-github.png](https://upload-images.jianshu.io/upload_images/16648241-0b6a9b7a3eac5160.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-Cygwin.png](https://upload-images.jianshu.io/upload_images/16648241-b1e0350c7127ae3e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-MSYS.png](https://upload-images.jianshu.io/upload_images/16648241-4041a40bd3bcdef5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bassh-MSYS2-homepage.png](https://upload-images.jianshu.io/upload_images/16648241-4bc6f49149cacbbf.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-mintty-summary.png](https://upload-images.jianshu.io/upload_images/16648241-dc4b0a4e9eb0d72f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-GNU.png](https://upload-images.jianshu.io/upload_images/16648241-b8d2fce5b4fe6a7a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-MinGw4.png](https://upload-images.jianshu.io/upload_images/16648241-4b6ada6c6fa8821a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

> `MinGW64` 和 `MinGW32` 都是 `MinGW` 系统,分别对应 `Windows` 的64位和32位操作系统.

![git-bash-mintty.png](https://upload-images.jianshu.io/upload_images/16648241-6f293cc3d437cb00.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![git-bash-again.png](https://upload-images.jianshu.io/upload_images/16648241-5cab2cd742020f00.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
