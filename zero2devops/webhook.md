...
http://localhost:9000/hooks/file
```
...
echo "snowdreams1006.github.io has been updated"
...
echo "webhook.snowdreams1006.cn has been received"
```
...
#!/bin/bash
curl -H "Content-Type:application/json" -X POST -d @testRequest.json \
https://webhook.snowdreams1006.cn/hooks
```