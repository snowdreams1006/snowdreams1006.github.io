...
```
{
    "data": {
        "x": "x",
        "columns": [
            ["x","2019-04-01","2019-04-02","2019-04-03","2019-04-04","2019-04-05","2019-04-06","2019-04-07"],
            ["粉丝",58,60,59,69,68,68,68,69],
            ["阅读",13809,14757,15707,18521,19268,20532,21328,22418]
        ],
        "axes": {
            "粉丝": "y2"
        },
...
```
{
    "data": {
        "x": "x",
        "columns": [
            ["x","2019-04-01","2019-04-02","2019-04-03","2019-04-04","2019-04-05","2019-04-06","2019-04-07","2019-04-08"],
            ["粉丝",8,8,8,9,9,9,9,9],
            ["阅读量",3508,3645,3650,4356,4528,4864,5276,5593],
            ["手记",32,33,34,36,38,39,40,41],
            ["推荐",36,36,37,39,41,42,48,49],
            ["积分",107,118,118,130,130,141,152,173]
        ],
        "axes": {
            "粉丝": "y2"
        },
...
```
{
    "data": {
        ...
        "columns": [
            ["x","2019-04-01","2019-04-02","2019-04-03","2019-04-04","2019-04-05","2019-04-06","2019-04-07","2019-04-08"],
            ["粉丝",7,7,6,7,6,5,5,5],
            ["阅读量",343,335,342,358,374,443,468,512],
            ["文章",33,34,35,37,39,40,41,42],
            ["喜欢",57,58,59,60,62,64,65,67],
            ["简书钻",27,28,28,9,9,9,10,10]
        ],
        "axes": {
            "粉丝": "y2"
        },
...
```
{
    "data": {
        ...
        "columns": [
            ["x","2019-04-01","2019-04-02","2019-04-03","2019-04-04","2019-04-05","2019-04-06","2019-04-07","2019-04-08"],
            ["粉丝",1,1,1,1,1,1,1,1],
            ["访问量",1565,1634,1665,1705,1723,1769,1829,1867],
            ["原创",31,32,33,34,36,38,39,40],
            ["喜欢",31,32,33,34,36,37,37,38],
            ["积分",353,364,376,397,419,430,440,450]
        ],
        "axes": {
            "粉丝": "y2"
        },
...
```
{
    "data": {
        ...
        "columns": [
            ["x","2019-04-01","2019-04-02","2019-04-03","2019-04-04","2019-04-05","2019-04-06","2019-04-07","2019-04-08"],
            ["粉丝",17,17,17,18,18,18,18,18],
            ["阅读数",3889,4096,4207,4388,4411,4435,4471,4728],
            ["随笔",31,32,33,34,36,38,39,41],
            ["评论数",16,16,16,16,16,16,16,16]
        ],
        "axes": {
            "粉丝": "y2"
        },
...
```
{
    "data": {
        ...
        "columns": [
            ["x","2019-04-01","2019-04-02","2019-04-03","2019-04-04","2019-04-05","2019-04-06","2019-04-07","2019-04-08"],
            ["关注者",4,5,5,6,6,6,6,6],
            ["阅读数",402,500,562,703,712,725,745,766],
            ["原创",31,32,33,35,37,38,39,40],
            ["点赞数",36,38,40,47,50,51,52,56]
        ],
        "axes": {
            "关注者": "y2"
        },
...
```
{
    "data": {
        ...
        "columns": [
            ["x","2019-04-01","2019-04-02","2019-04-03","2019-04-04","2019-04-05","2019-04-06","2019-04-07","2019-04-08"],
            ["粉丝",1,1,1,1,1,1,1,1],
            ["阅读量",1382,1483,1548,1676,1770,1891,2004,2087],
            ["文章",33,34,35,36,39,40,41,42],
            ["点赞数",12,12,13,13,13,13,15,16],
            ["声望",43,43,43,43,43,43,49,52]
        ],
        "axes": {
            "粉丝": "y2"
        },
...
```
{
    "data": {
        ...
        "columns": [
            ["x","2019-04-01","2019-04-02","2019-04-03","2019-04-04","2019-04-05","2019-04-06","2019-04-07","2019-04-08"],
            ["粉丝",12,13,13,13,13,13,13,14],
            ["访问量",2496,2831,3490,3947,3993,4066,4174,4391],
            ["博文",33,34,35,37,39,40,41,42],
            ["推荐",6,7,7,7,7,7,8,8],
            ["积分",5,5,6,6,7,7,7,7]
        ],
        "axes": {
...
```
{
    "data": {
        ...
        "columns": [
            ["x","2019-04-01","2019-04-02","2019-04-03","2019-04-04","2019-04-05","2019-04-06","2019-04-07","2019-04-08"],
            ["粉丝",1,1,1,1,1,2,2,2],
            ["阅读量",179,184,190,196,196,208,217,225],
            ["投稿",32,33,34,36,38,39,40,41],
            ["点赞",32,33,34,36,38,38,39,40],
            ["收藏",6,6,6,6,6,6,6,7],
            ["投币",1,1,1,1,1,1,1,1]
        ],
        "axes": {
...
```
{
    "data": {
        "x": "x",
        "columns": [
            ["x","2019-04-04","2019-04-05","2019-04-06","2019-04-07","2019-04-08"],
            ["粉丝",13,13,13,13,13],
            ["阅读量",1192,1561,2131,2144,2149],
            ["文章",34,34,34,34,34],
            ["点赞",107,108,110,107,107]
        ],
        "axes": {
            "粉丝": "y2"
        },
