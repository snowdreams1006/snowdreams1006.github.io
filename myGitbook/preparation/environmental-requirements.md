...
> 参考[安装gitbook的一些问题gitbook init和if (cb) cb.apply(this, arguments)，cb.apply is not a function](https://blog.csdn.net/weixin_42349568/article/details/108414441)
...
根据提示,打开 `I:\nodejs\node_modules\gitbook-cli\node_modules\npm\node_modules\graceful-fs\polyfills.js` 文件全部注释掉 `fs.stat = statFix(fs.stat)` 的调用!
