...
![12306-algorithm-web-js-index-cookie-id.png](https://tva1.sinaimg.cn/large/0082zybply1gby31dta8hj31g10u0k1m.jpg)
...
![12306-algorithm-web-js-index-cookie-RAIL_DEVICEID.png](https://tva1.sinaimg.cn/large/0082zybply1gby30hdao2j31z40sows6.jpg)
...
![12306-algorithm-web-js-index-copy-cookie-id.png](https://tva1.sinaimg.cn/large/0082zybply1gby30pf83xj31z40m0gs5.jpg)
...
![12306-algorithm-web-js-website-clear-storage.png](https://tva1.sinaimg.cn/large/0082zybply1gby314jx94j31gb0u04b9.jpg)
...
![12306-algorithm-web-js-website-clear-name.png](https://tva1.sinaimg.cn/large/0082zybply1gby30jop3jj31g90u0wp2.jpg)
...
![12306-algorithm-web-js-website-find-logdevice.png](https://tva1.sinaimg.cn/large/0082zybply1gby30qepqkj31g90u014h.jpg)
...
![12306-algorithm-web-js-website-cache-OkLJUJ.png](https://tva1.sinaimg.cn/large/0082zybply1gby30nl86dj31i60u0tjw.jpg)
...
![12306-algorithm-web-js-website-generate-compare.png](https://tva1.sinaimg.cn/large/0082zybply1gby30oldfsj31g60u0gy8.jpg)
...
众所周知,谷歌 Chrome 浏览器是程序员专属的浏览器,是因为提供了强大的**开发调试能力**,简单网站请求甚至根本不需要借助第三方专业的抓包工具就能**独立完成分析整过程**.
...
![12306-algorithm-web-js-non-trace-mode.png](https://tva1.sinaimg.cn/large/0082zybply1gby30s6k0ej31dm0u0q8z.jpg)
...
![12306-algorithm-web-js-network-listen.png](https://tva1.sinaimg.cn/large/0082zybply1gby30rfs9pj31fp0u0qcd.jpg)

准备工作就绪后开始完整走一遍购票流程,即从首页进入登录页,登录并买票等过程,请求步骤越完整可提供分析的资料越多,也就基本上不会遗漏重要步骤,离真相越逼近.

![12306-algorithm-web-js-query-ticket.png](https://tva1.sinaimg.cn/large/0082zybply1gby30gdx5sj31fw0u0tpw.jpg)

凡是涉及到登录操作,建议**先故意输出错误的账号密码等信息**,这样有利于登录成功后重定向次数过多而导致无法找到之前的登录请求,如果网络(network)选项卡中的保持日志(Preserve log)的功能没有开启的话,这一现象将会更加严重!

![12306-algorithm-web-js-login-wrong.png](https://tva1.sinaimg.cn/large/0082zybply1gby30my8c9j31ge0u07ij.jpg)

再次输入正确的登录信息成功登录后进行买票行为等操作,但是无需付款,只要正常操作到下单完成即可视为整个购票流程.

![12306-algorithm-web-js-purse-ticket.png](https://tva1.sinaimg.cn/large/0082zybply1gby31fhnyij31g40u0qi0.jpg)

![12306-algorithm-web-js-order-ticket.png](https://tva1.sinaimg.cn/large/0082zybply1gby31ink3cj31g20u04dd.jpg)
...
![12306-algorithm-web-js-network-search.png](https://tva1.sinaimg.cn/large/0082zybply1gby31hm9e6j31z40i6tfq.jpg)

不搜不要紧,一搜一大把,只能看出来大部分网络请求都会自动携带该 cookie,反而淹没了到底是哪个网络请求生成的 cookie?

![12306-algorithm-web-js-network-search-result.png](https://tva1.sinaimg.cn/large/0082zybply1gby319y8qzj31z40iegu1.jpg)
...
同样地,在网络(network)选项卡选择第三个过滤器漏斗图标,展开网络请求类型,大致分为 `All|XHR|JS|CSS|Img|Media|Font|Doc|WS|Manifest|Other`等类型.
...
![12306-algorithm-web-js-network-search-result-xhr.png](https://tva1.sinaimg.cn/large/0082zybply1gby3170s6zj31z40sik2d.jpg)

Doc 请求的重点就不一样了,绝大多数请求就是输入网址后自动跳转页面,因而关注的重点应该放在请求头和响应头信息上,因为 cookie 的值就是通过请求头进行发送到后端服务器,后端如需新增或修改 cookie 值就是通过响应头进行设置的.

![12306-algorithm-web-js-network-search-result-doc.png](https://tva1.sinaimg.cn/large/0082zybply1gby31gq17qj31z40sk13i.jpg)
...
![12306-algorithm-web-js-network-search-cookie-RAIL_DEVICEID.png](https://tva1.sinaimg.cn/large/0082zybply1gby30hqjcbj31gh0u0qg1.jpg)
...
![12306-algorithm-web-js-network-search-cookie-JSESSIONID.png](https://tva1.sinaimg.cn/large/0082zybply1gby31bm6cyj31z40sok1i.jpg)
...
![12306-algorithm-web-js-network-search-js-cookie-RAIL_DEVICEID.png](https://tva1.sinaimg.cn/large/0082zybply1gby30uopmfj31z40sek3i.jpg)
...
![12306-algorithm-web-js-network-search-js-cookie-analysis-RAIL_DEVICEID.png](https://tva1.sinaimg.cn/large/0082zybply1gby30grp6qj31z40sows6.jpg)
...
![12306-algorithm-web-js-source-workspace-pannel.png](https://tva1.sinaimg.cn/large/0082zybply1gby314s59nj31z40se780.jpg)
...
![12306-algorithm-web-js-source-command-search.png](https://tva1.sinaimg.cn/large/0082zybply1gby30qrfqij31z40sigpy.jpg)

输入搜索 `search` 后果然弹出了相关搜索命令,于是点击开发工具(DevTools)后出现了搜索框,顺理成章输入关键字 `RAIL_DEVICEID` 进行搜索了啊!

![12306-algorithm-web-js-source-search-result.png](https://tva1.sinaimg.cn/large/0082zybply1gby30wdjbnj31z40sgqac.jpg)
...
![12306-algorithm-web-js-source-getjs-pretty.png](https://tva1.sinaimg.cn/large/0082zybply1gby30svg5uj31z40scwvo.jpg)

点击中间区域的左下角格式化图标进行美化代码,然后在文件中搜素关键字 `RAIL_DEVICEID` 定位到具体代码.

非常人性化的是,搜索功能是通用的快捷键 Ctrl + F,现在定位到具体代码,截图留念下,接下来才是真正考验技术的时刻!

![12306-algorithm-web-js-source-getjs-search.png](https://tva1.sinaimg.cn/large/0082zybply1gby30o0iflj31z40sok1b.jpg)
...
![12306-algorithm-web-js-source-getjs-backup.png](https://tva1.sinaimg.cn/large/0082zybply1gby317w5tpj31yy0sajxh.jpg)
...
![12306-algorithm-web-js-source-getjs-debug.png](https://tva1.sinaimg.cn/large/0082zybply1gby30tys7zj31z40sm7gw.jpg)
...
![12306-algorithm-web-js-source-getjs-debug-watch.png](https://tva1.sinaimg.cn/large/0082zybply1gby31aock8j31yw0skqen.jpg)
...
![12306-algorithm-web-js-source-getjs-debug-finally.png](https://tva1.sinaimg.cn/large/0082zybply1gby319971ij31c00u01as.jpg)

一次请求完成后顺利生成了 cookie 也写入了本地缓存中,如果不清空那么进入下一次断点的流程就和这一次不一样了,所以为了可重复操作,再次断点调试时需要还原操作环境.

![12306-algorithm-web-js-source-getjs-debug-write.png](https://tva1.sinaimg.cn/large/0082zybply1gby31g72ogj31z40sgdlk.jpg)

首次加载时变量 a 并没有值,一不小心进入下一个过程时,这一次 a 已经有值了,多次试验后搞清楚了数据流向也明白了如何还原操作环境,保持实验结果的一致性.

![12306-algorithm-web-js-source-getjs-debug-repeat.png](https://tva1.sinaimg.cn/large/0082zybply1gby318ow4rj31z20sin9r.jpg)
...
现在已经还原了算法的实现逻辑,下一步就是如何更好地伪造自己,本文提供**临时设置**的实现方式,方便在不修改之前复现代码的基础上实现扩展,当然也可以**直接在还原算法源码中写入伪造代码**.
...
![12306-algorithm-web-js-website-console-ajax.png](https://tva1.sinaimg.cn/large/0082zybply1gby30ihaqcj31g10u0wsm.jpg)
