...
(function(global) {
    global[_decodeLink[0]] = _decodeLink[1];
})(window);
...
var __Ox552c9 = [
    ...
    "css", 
    "BTWPlugin",
    '<div id="read-more-wrap"><div id="read-more-mask"></div><a id="read-more-btn" target="_self">阅读全文</a></div>',
    "append", 
    "click", 
    "#read-more-wrap", 
    "hide", 
    ...
    '        <input id="btw-modal-input" type="text" maxlength="10" placeholder="请输入验证码">',
    '        <button id="btw-submit-btn">提 交</button>',
    '      </div>',
    '      <p id="btw-footer">该工具由 <a href="https://blog.snowdreams1006.cn/"  target="_blank">snowdreams1006.cn</a>  提供技术支持</p>',
    '    </div>', 
    '  </div>',
    "#btw-modal-close-btn, #btw-mask", 
    "#btw-submit-btn", 
    "val",
    "#btw-modal-input", 
    "remove", 
    ...
    "请输入校验码！",
    "focus",
    "https://eladmin.snowdreams1006.cn/api/miniMp/checkVipCode",
    "?blogId=", 
    "&code=", 
    "result",
    "setItem",
    "#btw-modal-wrap, #read-more-wrap", 
    "校验码有误！", 
    "get", 
    "position",
    "relative", 
    ...
    "200px",
    "-webkit-gradient(linear, 0 top ,0 bottom, from(rgba(255, 255, 255, 0)), to(#FFF))",
    "#read-more-mask", 
    "safari", 
    "background", 
    "opera",
    "-o-linear-gradient(bottom, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))",
    "mozilla",
    "-moz-linear-gradient(top, rgba(255, 255, 255, 0.1), white",
    "msie",
    "-ms-linear-gradient(linear, 0 top ,0 bottom, from(rgba(255, 255, 255, 0)), to(#FFF))",
    "50%", 
    "70%", 
    "30px", 
    "translate(-50%, -50%)", 
    ...
    "white", 
    "logical",
    "#btw-modal-input-code input", 
    "180px", 
    "8px solid #e6e6e6",
    "#btw-modal img", 
    "0 20px", 
    "14px",
    "#btw-modal-input-code button", 
    "#B34F54", 
    "0.7", 
    "999", 
    "#000",
