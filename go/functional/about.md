...
在正式学习函数式编程之前,不访跟早已熟悉的面向对象编程做下类比学习,通过对比学习相信你一定会收获满满,因此整理出来关于 `Go` 语言的面向对象系列文章,邀君共赏.
...
**数学家**向来以严谨求学著称,作为最重要的基础科学,数学规律以及归纳演绎方法论对应的就是**函数式编程**,不再模拟现实而是**描述**规律更有可能创造规律.
